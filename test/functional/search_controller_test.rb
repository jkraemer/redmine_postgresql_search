...
class SearchControllerTest < ActionController::TestCase
  ...
  def test_search_all_projects
    ...
    assert assigns(:results).include?(Changeset.find(100))
    ...
    get :index, :q => 'recipe subproject commit', :all_words => '', page: 2
  ...
  def test_search_content
    Issue.find(1).update_attribute :description, 'This is a searchkeywordinthecontent'
